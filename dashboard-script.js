...
function openOscarSpeech() {
    ...
    if (modal) {
        ...
        if (textContainer) {
            ...
            const speechText = "Oh my goodness! I can't believe it! We did it! This Oscar isn't just mine—it's ours. Thank you so much for being with me through every draft, every rejection, and every moment of doubt. To my team, you believed when I didn't. To TENSEFLIX, thank you for making me a better communicator. And to everyone learning languages out there—you're not just learning words, you're opening doors to new worlds. This is our victory! Thank you!";
